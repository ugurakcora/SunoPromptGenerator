...
export default function MixingSection({ options, onChange }: MixingSectionProps) {
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
        ...
        <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white break-words">5. Mixing</h2>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => onChange({ mixingStyle: value || undefined })}
          >
