      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-5">
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ musicalTradition: value || undefined })
            }
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ primaryInstrument: value || undefined })
            }
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ rhythmicFeel: value || undefined })
            }
          >
            <SelectTrigger className="w-full bg-background/50 border-border/50 text-foreground h-10 sm:h-11 md:h-12 text-sm sm:text-base">
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ scaleMode: value || undefined })
            }
          >
            <SelectTrigger className="w-full bg-background/50 border-border/50 text-foreground h-10 sm:h-11 md:h-12 text-sm sm:text-base">
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ musicalTexture: value || undefined })
            }
          >
            <SelectTrigger className="w-full bg-background/50 border-border/50 text-foreground h-10 sm:h-11 md:h-12 text-sm sm:text-base">
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ performanceContext: value || undefined })
            }
          >
            <SelectTrigger className="w-full bg-background/50 border-border/50 text-foreground h-10 sm:h-11 md:h-12 text-sm sm:text-base">
        ...
        <div className="space-y-1.5 sm:space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ worldVocalStyle: value || undefined })
            }
          >
            <SelectTrigger className="w-full bg-background/50 border-border/50 text-foreground h-10 sm:h-11 md:h-12 text-sm sm:text-base">
        ...
        <div className="md:col-span-2 space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              onChange({ atmosphere: value || undefined })
            }
          >
            <SelectTrigger className="w-full bg-background/50 border-border/50 text-foreground h-10 sm:h-11 md:h-12 text-sm sm:text-base">
